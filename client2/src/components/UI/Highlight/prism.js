/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+css-extras+jsx+regex+scss&plugins=line-highlight+line-numbers+custom-class+show-language+highlight-keywords+toolbar+match-braces */
...
(function () {
	...
	var Languages = /*languages_placeholder[*/{
		...
		"sass": "Sass (Sass)",
		"scss": "Sass (Scss)",
		"shell-session": "Shell session.go",
		"sh-session": "Shell session.go",
		"shellsession": "Shell session.go",
		"sml": "SML",
		"smlnj": "SML/NJ",
