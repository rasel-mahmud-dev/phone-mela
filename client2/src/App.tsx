...
const App:FC<AppProps> = (props) => {
  ...
  React.useEffect(()=>{
    ...
    if(auth.isAuthenticated) {
      props.fetchCart(auth.id)
      props.fetchWishlist(auth.id)
    } else {
      props.fetchCart()
    }
      ...
      <div id="appContent">
        ...
        <AppWrapper>
          ...
          <Backdrop onCloseBackdrop={clickOnBackdrop} isOpenBackdrop={true} bg="#00000030">
            <div className="bg-white w-[500px] mx-auto fixed top-1/4 left-1/2 transform -translate-x-1/2 rounded">
              <div className="p-4 shadow-lg">
                <div className="relative">
                  <h1 className="font-medium text-lg">{action.message}</h1>
